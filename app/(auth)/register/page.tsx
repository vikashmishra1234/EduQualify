    ...
    <Card className="bg-zinc-900/60 backdrop-blur-xl border-zinc-800 shadow-2xl">
      <CardHeader className="space-y-1">
        ...
        <CardDescription className="text-center text-slate-400">
          Enter your information to get started with assessments
        </CardDescription>
      </CardHeader>
      ...
      <CardFooter className="flex flex-col gap-2 text-center text-sm text-slate-500">
        <div>
          ...
          <Link href="/login" className="underline underline-offset-4 hover:text-indigo-400 text-indigo-500 font-medium transition-colors">
            Sign in
          </Link> 
        </div>
      </CardFooter>
